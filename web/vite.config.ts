...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Browser Canary e2e-create-mrttq80c-me924m-test",
        short_name: "Browser Canary e2e-create-mrttq80c-me924m-test",
        description: "Browser Canary e2e-create-mrttq80c-me924m-test — free forever",
        start_url: "/",
        display: "standalone",
